...
public class EstimateDao {
    ...
    public int insertCustomer(Customer customer) {
        String sql = "INSERT INTO CUSTOMER(MOVING_DATE, OLD_PREFECTURE_ID, NEW_PREFECTURE_ID, CUSTOMER_NAME, TEL, EMAIL, OLD_ADDRESS, NEW_ADDRESS)"
                + " VALUES(:dates, :oldPrefectureId, :newPrefectureId, :customerName, :tel, :email, :oldAddress, :newAddress)";
